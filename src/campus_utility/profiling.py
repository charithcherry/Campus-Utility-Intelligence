...
def render_profile_report(raw_dir: Path, profiles: Iterable[FileProfile]) -> str:
    ...
    lines = [
        ...
        "## Purpose",
        "",
        "This report profiles the raw Kaggle UNICON files before ingestion. It shows what files exist, what columns they contain, and what data-quality risks need to be handled later.",
        "",
        "## What This Checks",
        "",
        "- File row and column counts",
        "- Column names and inferred pandas data types",
        "- Null counts and null rates",
        "- Full-row duplicate counts",
        "- Timestamp coverage for date-like columns",
        "- Sample records for schema inspection",
        "",
        "## Why This Matters",
        "",
        "Profiling prevents invented schemas. The next layers use these findings to decide what should be loaded into bronze and what must be cleaned in silver.",
        "",
